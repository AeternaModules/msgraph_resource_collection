output "resource_collections_id" {
  description = "Map of id values across all resource_collections, keyed the same as var.resource_collections except keys with no id are omitted"
...
output "resource_collections_api_version" {
  description = "Map of api_version values across all resource_collections, keyed the same as var.resource_collections except keys with no api_version are omitted"
...
output "resource_collections_output" {
  description = "Map of output values across all resource_collections, keyed the same as var.resource_collections except keys with no output are omitted"
...
output "resource_collections_read_query_parameters" {
  description = "Map of read_query_parameters values across all resource_collections, keyed the same as var.resource_collections except keys with no read_query_parameters are omitted"
...
output "resource_collections_reference_ids" {
  description = "Map of reference_ids values across all resource_collections, keyed the same as var.resource_collections except keys with no reference_ids are omitted"
...
output "resource_collections_response_export_values" {
  description = "Map of response_export_values values across all resource_collections, keyed the same as var.resource_collections except keys with no response_export_values are omitted"
...
output "resource_collections_retry" {
  description = "Map of retry values across all resource_collections, keyed the same as var.resource_collections except keys with no retry are omitted"
...
output "resource_collections_skip_destroy" {
  description = "Map of skip_destroy values across all resource_collections, keyed the same as var.resource_collections except keys with no skip_destroy are omitted"
...
output "resource_collections_url" {
  description = "Map of url values across all resource_collections, keyed the same as var.resource_collections except keys with no url are omitted"
